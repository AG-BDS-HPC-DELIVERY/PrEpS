= PrEpS (Prolog and Epilog for Slurm)

== About the Project

PrEpS (**Pr**olog and **Ep**ilog for **S**lurm) is a comprehensive but extensible framework for performing Prolog/Epilog execution inside the Slurm workload scheduler.
